...
<p>Your about to delete <a href="index.php?op=view&id={$e.id}" 
...
<p><a href="index.php?op=doDelete&timed_id={$saddr.__delete}" 
  title="Delete {$e.name.0}">Yes </a>
<a href="index.php?op=view&id={$e.id}" title="View {$e.name.0}">No</a></p>
{/if}
